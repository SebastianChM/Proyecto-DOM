...
> [!WARNING]
> **DOCUMENTO DEPRECADO**: Este documento fue creado cuando la aplicación usaba Basic Auth (`admin / dom-[contraseña]`).  
> **Acceso actual**: OAuth Autodesk solamente. Ver `docs/guides/GUIA_ACCESO_REMOTO.md` para instrucciones actualizadas.
...
- Auth: ✅ OAuth Autodesk (sin Basic Auth)

**Para verificar en el navegador:**

1. Abre <http://localhost:3000/dashboard/viewer>
2. Autentícate con OAuth Autodesk
...
**Fecha de corrección:** 2024-XX-XX  
**Archivos modificados:** 2  
**Tests ejecutados:** 6 casos de prueba  
**Estado:** ✅ RESUELTO (DEPRECATED - OAuth only)
