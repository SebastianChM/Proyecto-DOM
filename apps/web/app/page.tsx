    ...
    <div className="flex flex-col">
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex w-[55%] relative items-center justify-center overflow-hidden bg-gradient-to-br from-[#1e1b4b] via-[#1a1640] to-[#0f172a]">
          ...
          {/* Grid pattern */}
          <div className="absolute inset-0 opacity-[0.06] [background-image:linear-gradient(rgba(255,255,255,.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.08)_1px,transparent_1px)] [background-size:40px_40px]" />
          ...
          <div className="relative z-10 max-w-lg px-12 space-y-10">
            ...
            <div className="flex gap-10 pt-4">
              <div>
                ...
                <p className="text-xs text-[#74747e] uppercase tracking-wider mt-1">
                  Years of Excellence
                </p>
              </div>
        ...
        <div className="flex-1 flex items-center justify-center bg-background relative p-8">
          ...
          <div className="absolute inset-0 opacity-[0.015] dark:opacity-[0.03] [background-image:radial-gradient(circle_at_1px_1px,currentColor_1px,transparent_0)] [background-size:32px_32px]" />
