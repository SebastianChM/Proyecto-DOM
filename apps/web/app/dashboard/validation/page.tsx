      ...
      {activeTab === "upload" && !isFullscreen && (
        <div className="container mx-auto flex flex-col gap-2 shrink-0 py-4 px-6">
          <h1 className="text-3xl font-bold tracking-tight">
            Safety-Critical Compliance Engine
          </h1>
          <p className="text-muted-foreground">
            Automated verification of Engineering Technical specifications
            against BIM models (MOP / Universal Standards).
          </p>
        </div>
      )}
      ...
      >
        <div className="flex items-center justify-between shrink-0 mb-2 px-4 shadow-sm py-2 bg-background/95 backdrop-blur z-40 sticky top-0">
          <TabsList className="grid w-[300px] grid-cols-2">
            ...
            <TabsTrigger value="viewer" disabled={!validationData}>
              Compliance Report
            </TabsTrigger>
          </TabsList>
        ...
        <TabsContent value="upload" className="mt-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload a Technical Specification (PDF/Doc) and provide the
                unique BIM Model URN to begin the safety check.
              </CardDescription>
            </CardHeader>
            <CardContent>
