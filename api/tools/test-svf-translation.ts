...
const RAW_URN =
  "urn:adsk.objects:os.object:dom-bim-platform-us-test-001/1764554140148-mock-result.ifc";
...
async function testSvf() {
  ...
  try {
    ...
    const token = await import("../src/services/aps/auth.service").then((m) =>
      m.apsAuthService.getInternalToken(),
    );
