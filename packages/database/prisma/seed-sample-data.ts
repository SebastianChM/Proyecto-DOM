...
async function seedSampleData() {
  ...
  const projects = [
    {
      ...
      description:
        "Diseño estructural y MEP para torre de oficinas de 57 pisos",
      status: "Active",
    ...
    },
    {
      ...
      description:
        "Nuevo hospital con 500 camas, incluye instalaciones especiales",
      status: "Active",
  ...
  for (const projectData of projects) {
    ...
    console.log(
      `  ✅ Created project: ${project.name} with ${fileNames.length} files`,
    );
  }
